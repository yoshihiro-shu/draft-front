...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    <link to="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" to="https://nuxtjs.org" target="_blank">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a to="https://nuxtjs.org" target="_blank" class="button--doc text-green-500 hover:underline">Nuxt Documentation</a>, whether you are new or have previous experience with the framework.<br>
        </p>
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a to="https://github.com/nuxt/nuxt.js" target="_blank"><svg
        ...
        <a to="https://twitter.com/nuxt_js" target="_blank"><svg
